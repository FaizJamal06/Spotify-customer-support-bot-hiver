...
- **Single annotator, no inter-rater reliability measured**: all human judgments in this project — the 200 golden intent labels, the 40 triage decisions, and the 40 judge-calibration human scores — came from one person. This is a disclosed scope limitation, normal for a take-home, not a gap this report treats as needing a fix: no inter-rater reliability statistic exists anywhere in this repo, and every kappa/Spearman/agreement figure in this report reflects one annotator's judgment, not a consensus.
